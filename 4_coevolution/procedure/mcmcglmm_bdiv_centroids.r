...
for(compart in c('tissue','mucus','skeleton')) {
    ...
    bdwuni[[compart]] <- betadisper(wunis[[compart]],groups[[compart]],bias.adjust=T, type='centroid')

    bdbray[[compart]] <- betadisper(brays[[compart]],groups[[compart]],bias.adjust=T, type='centroid')
...
dir.create('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_bdiv_centroids/')


write.table(pedigree_hosts,file=paste0('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_bdiv_centroids/host_pedigree.txt'),sep='\t',quote=F,row.names=F)
...
save.image(file=paste0('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_bdiv_centroids/mcmc_setup.RData'))


Gs <- list(V=diag(6), nu=5.02)

prioriw <- list(R=list(V=diag(6),nu=5.02), G=list(G1=Gs, G2=Gs))
...
save.image(file=paste0('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_bdiv_centroids/mcmc_res.RData'))

sm <- summary(mc, random=T)

save.image(file=paste0('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_bdiv_centroids/mcmc_res_sm.RData'))

write.table(sm$Gcovariance, paste0('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_bdiv_centroids/mcmc_Gcovariance.txt'), sep='\t', quote=F)
write.table(sm$solutions, paste0('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_bdiv_centroids/mcmc_solutions.txt'), sep='\t', quote=F)
...
write.table(all_iccs, paste0('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_bdiv_centroids/mcmc_ICCs.txt'), sep='\t', quote=F)

pdf('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_bdiv_centroids/mcmc_VCVs_%03d.pdf', onefile=F)
plot(mc$VCV)
dev.off()
