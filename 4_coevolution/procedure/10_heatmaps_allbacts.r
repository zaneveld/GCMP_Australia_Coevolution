...
biom_object <- read_biom('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_allbacts/taxa_summaries/otu_table_mc2_wtax_no_pynast_failures_no_organelles_L6.biom')
...
for(compart in c('M','S','T')) {
    host.otu <- read.table(paste0('~/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_allbacts/',compart,'_parsed/',compart,'_Host.otu.txt'), sep='\t', header=T, as.is=T)
    ...
    #    write(sig.host,file=paste0('~/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_allbacts/',compart,'_parsed/',compart,'_sigs_by_host.txt'),sep='\n')
    
    host.otu.hostphy <- read.table(paste0('~/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_allbacts/',compart,'_parsed/',compart,'_Host.otu.hostphy.txt'), sep='\t', header=T, as.is=T)
    ...
    #    write(sig.hostphy,file=paste0('~/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_allbacts/',compart,'_parsed/',compart,'_sigs_by_hostphy.txt'),sep='\n')

    sig.hosts <- unique(c(host.otu.parsed[,2],host.otu.hostphy.parsed[,2]))


    func.otu <- read.table(paste0('~/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_allbacts/',compart,'_parsed/',compart,'_func.otu.txt'), sep='\t', header=T, as.is=T)
    ...
    #    write(sig.func,file=paste0('~/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_allbacts/',compart,'_parsed/',compart,'_sigs_by_func.txt'),sep='\n')
    ...
    for(set in names(sets)) {
        ...
        yep <- function(nothing) {
        pdf(paste0('~/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_allbacts/',compart,'_parsed/',compart,'_',set,'_heatmap_scalebyrow.pdf'))
        ...
        pdf(paste0('~/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_allbacts/',compart,'_parsed/',compart,'_',set,'_heatmap_scalebycol.pdf'))
        ...
        pdf(paste0('~/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_allbacts/',compart,'_parsed/',compart,'_',set,'_heatmap_noscale.pdf'))
        ...
        pdf(paste0('~/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_allbacts/',compart,'_parsed/',compart,'_',set,'_heatmap_sqrt_scalebyrow.pdf'))
        ...
        pdf(paste0('~/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_allbacts/',compart,'_parsed/',compart,'_',set,'_heatmap_scalebytaxamax.pdf'))
        ...
        pdf(paste0('~/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_allbacts/',compart,'_parsed/',compart,'_',set,'_heatmap_sqrt_scalebytaxamax.pdf'))
        sqrtrel <- sqrt(baserel_filt)
        ...
        pdf(paste0('~/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_allbacts/',compart,'_parsed/',compart,'_',set,'_heatmap_sqrt.pdf'))
        sqrtrel <- sqrt(baserel_filt)
