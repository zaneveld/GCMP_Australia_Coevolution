...
for(compart in c('T','M','S')) {
    ...
    for(set in names(sets)) {
        ...
        pdf(paste0('~/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_allbacts_fixed/',compart,'_parsed/wuni_',compart,'_',set,'_heatmap_scalebytaxamax.pdf'))
        ...
        pdf(paste0('~/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_allbacts_fixed/',compart,'_parsed/wuni_',compart,'_',set,'_heatmap_sqrt_scalebytaxamax.pdf'))
        ...
        pdf(paste0('~/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_allbacts_fixed/',compart,'_parsed/wuni_',compart,'_',set,'_heatmap_sqrt.pdf'))
        sqrtrel <- sqrt(baserel_filt)
