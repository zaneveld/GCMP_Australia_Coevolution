...
biom_object <- import_biom(BIOMfilename='/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_subsets/endos_2/MED_endos_newtax.json')
...
famlist <- list(T=c('g__Poriticola','g__Diversicola'))

for(compart in c('T')) {

    for(taxon in famlist[[compart]]) {
        
        tre <- read.nexus(paste0('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_subsets/endos_2/',taxon,'/beast/',taxon,'_final_tree.tree'))
        ...
        for(type in c('with_reference','without_reference')) {
            ...
            pdf(paste0('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_subsets/endos_2/',taxon,'/',taxon,'_',type,'_heatmap_scalebyrow_finer.pdf'))
            ...
            pdf(paste0('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_subsets/endos_2/',taxon,'/',taxon,'_',type,'_heatmap_scalebycol_finer.pdf'))
            ...
            pdf(paste0('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_subsets/endos_2/',taxon,'/',taxon,'_',type,'_heatmap_noscale_finer.pdf'))
            ...
            pdf(paste0('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_subsets/endos_2/',taxon,'/',taxon,'_',type,'_heatmap_sqrt_scalebyrow_finer.pdf'))
            ...
            pdf(paste0('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_subsets/endos_2/',taxon,'/',taxon,'_',type,'_heatmap_scalebytaxamaxrow_finer.pdf'))
            ...
            pdf(paste0('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_subsets/endos_2/',taxon,'/',taxon,'_',type,'_heatmap_scalebytaxamax_finer.pdf'))
            maxrel <- t(apply(baserel_filt, 1, function(x) x/max(x)))
            ...
            pdf(paste0('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_subsets/endos_2/',taxon,'/',taxon,'_',type,'_heatmap_sqrt_scalebytaxamax_finer.pdf'))
            sqrtrel <- sqrt(baserel_filt)
