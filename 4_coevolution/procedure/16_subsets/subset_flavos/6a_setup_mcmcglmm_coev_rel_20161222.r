...
good_tax <- import_biom('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_subsets/flavos/MED_flavos_newtax.json')
...
for(compart in c('T')) {
    ...
    for(taxon in famlist[[compart]]) {
        ...
        dir.create(paste0('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_subsets/flavos_binary_presence/',compartments[[compart]],'/',taxon,'/'), recursive=T)
        
        tre <- read.nexus(paste0('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_subsets/flavos/g__Coralicola_robust/beast/',taxon,'_final_tree.tree'))
        ...
        write.table(pedigree_hosts,file=paste0('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_subsets/flavos_binary_presence/',compartments[[compart]],'/',taxon,'/',taxon,'_host_pedigree.txt'),sep='\t',quote=F,row.names=F)
        ...
        write.table(pedigree_bacts,file=paste0('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_subsets/flavos_binary_presence/',compartments[[compart]],'/',taxon,'/',taxon,'_bact_pedigree.txt'),sep='\t',quote=F,row.names=F)
        ...
        save.image(file=paste0('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_subsets/flavos_binary_presence/',compartments[[compart]],'/',taxon,'/',taxon,'_mcmc_setup.RData'))
    }
}