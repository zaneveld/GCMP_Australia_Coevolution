...
biom_object <- import_biom(BIOMfilename='/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_subsets/chromerida_S/MED_chromerida_newtax.json')
colnames(tax_table(biom_object)) <- c('Class','Order','Family','Genus')
...
taxdat <- read.table('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_subsets/chromerida_S/new_taxonomy_gg99/gg99_chromerida_tax_assignments.txt',sep='\t',stringsAsFactors=F, row.names=1)
...
famlist <- list(S=c('f__Chromerida'))

for(compart in c('S')) {

    for(taxon in famlist[[compart]]) {
        
        tre <- read.nexus(paste0('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_subsets/chromerida_S/',taxon,'/beast/',taxon,'_final_tree.tree'))
        ...
        for(type in c('with_reference','without_reference')) {
            ...
            pdf(paste0('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_subsets/chromerida_S/',taxon,'/',taxon,'_',type,'_heatmap_scalebyrow_finer.pdf'))
            ...
            pdf(paste0('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_subsets/chromerida_S/',taxon,'/',taxon,'_',type,'_heatmap_scalebycol_finer.pdf'))
            ...
            pdf(paste0('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_subsets/chromerida_S/',taxon,'/',taxon,'_',type,'_heatmap_noscale_finer.pdf'))
            ...
            pdf(paste0('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_subsets/chromerida_S/',taxon,'/',taxon,'_',type,'_heatmap_sqrt_scalebyrow_finer.pdf'))
            ...
            pdf(paste0('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_subsets/chromerida_S/',taxon,'/',taxon,'_',type,'_heatmap_scalebytaxamaxrow_finer.pdf'))
            ...
            pdf(paste0('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_subsets/chromerida_S/',taxon,'/',taxon,'_',type,'_heatmap_scalebytaxamax_finer.pdf'))
            maxrel <- t(apply(baserel_filt, 1, function(x) x/max(x)))
            ...
            pdf(paste0('/Users/Ryan/Dropbox/Selectively_Shared_Vega_Lab_Stuff/GCMP/Projects/Australia_Coevolution_Paper/16S_analysis/4_coevolution/output/mcmcglmm_subsets/chromerida_S/',taxon,'/',taxon,'_',type,'_heatmap_sqrt_scalebytaxamax_finer.pdf'))
            sqrtrel <- sqrt(baserel_filt)
